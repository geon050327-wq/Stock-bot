...
# ---------------------------------------------------------
# 🔥 [핵심 수정] 모니터 없는 서버에서 차트 그릴 때 필수 설정
# 이 두 줄이 없으면 깃허브에서 100% 에러 납니다.
import matplotlib
matplotlib.use('Agg') 
...
print("🎨 [Visual Mode] 차트 그리기(Agg모드) 시작...")
...
print("🚀 [전송 완료] Matplotlib Agg 모드 적용됨!")
